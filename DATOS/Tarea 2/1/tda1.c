...
void append1(tLista* l, int item1, int item2){
    int x;
    x = l->pos;
...
/*****
*
TipoFunción NombreFunción : ObtenerValor1
******
*
...
int ObtenerValor1(tLista* l, int pos){
    int x1;
    moveToPos(l,pos);
    x1 = l->curr->info1;
    return x1;
...
/*****
*
TipoFunción NombreFunción : ObtenerValor2
******
*
Resumen Función : funcion utilizada para acceder a la info2 del struct nodo
******
*
Input: puntero de tipo lista ;  entero con la posicion del nodo a revisar
tipoParámetro NombreParámetro : tLista* l ; int pos
...
*
Returns:
TipoRetorno, Descripción retorno : retorna int, el retorno es la info2 del nodo en cuestion
*****/


int ObtenerValor2(tLista* l, int pos){
    int x1;
    moveToPos(l,pos);
    x1 = l->curr->info2;
    return x1;
